...
Route::get("Mass5", [TestController::class, 'Mass5']);
Route::get('Mass6', [TestController::class, 'Mass6']);
Route::get('Mass7', [TestController::class, 'Mass7']);
Route::get('Mass8', [TestController::class, 'Mass8']);